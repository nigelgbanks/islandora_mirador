{
    ...
    "modules": {
        ...
        "embedDialogue": {
            "options": {
                "embedTemplate": "<div class=\"wellcomePlayer\" data-uri=\"{0}\" data-assetsequenceindex=\"{1}\" data-assetindex=\"{2}\" data-zoom=\"{3}\" data-config=\"{4}\" style=\"width:{5}px; height:{6}px; background-color: #000\"></div>\n<script type=\"text/javascript\" id=\"embedWellcomePlayer\" src=\"{7}\"></script><script type=\"text/javascript\">/* wordpress fix */</script>"
            },
            "content": {
                "title": "Embed",
